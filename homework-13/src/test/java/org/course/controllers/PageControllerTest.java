...
class PageControllerTest {
    ...
    public static final DbRole ROLE = new DbRole(1L, DbRoleEnum.ADMIN, null);
    public static final Set<DbPermission> PERMISSIONS = Set.of(new DbPermission(1L, DbPermissionEnum.BOOK_MANAGE, ROLE),
            new DbPermission(1L, DbPermissionEnum.BOOK_CREATE, ROLE),
            new DbPermission(2L, DbPermissionEnum.BOOK_UPDATE, ROLE),
            new DbPermission(3L, DbPermissionEnum.BOOK_DELETE, ROLE));
    public static final User USER = new User(1L, "E", "F", "L", "P", true, ROLE);
    ...
    public static final PagingAttributes PAGING_ATTRIBUTES = new PagingAttributes(3, List.of(1),
            List.of(3), 2, 3, 1);
    ...
    void shouldMapManageView() throws Exception {
        ...
        GrantedAuthority authority = new SimpleGrantedAuthority(DbPermissionEnum.BOOK_MANAGE.name());
    ...
    void shouldMapUpdateBookView() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/manage/book/update/" + BOOK_ID)
                .with(SecurityMockMvcRequestPostProcessors.user(USER)))
