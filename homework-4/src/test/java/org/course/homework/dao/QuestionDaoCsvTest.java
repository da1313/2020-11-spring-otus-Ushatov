...
class QuestionDaoCsvTest {
    ...
    @Mock
    private LocaleResourceLocator resourceLocator;
    ...
    void throwsExceptionsIfFileNotFound() {
        ...
        Mockito.lenient().when(resourceLocator.getResource()).thenReturn(fileName);
        QuestionDaoCsv questionDaoCsv = new QuestionDaoCsv(resourceLocator, parser);
