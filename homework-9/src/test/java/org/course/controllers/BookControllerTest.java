...
class BookControllerTest {
    ...
    void shouldReturnMainViewAndSetAttributes() throws Exception {
        ...
        MainPageParams mainPageParams = new MainPageParams(GENRE_ID, "new", CURRENT_PAGE, TOTAL_PAGES, IS_SEARCH, QUERY);

        MainPageAttributes mainPageAttributes = new MainPageAttributes(mainPageParams, bookList, genreList);

        Mockito.when(bookHandleService.getMainPageAttributes(GENRE_ID, "new", NEXT_PAGE, IS_SEARCH, QUERY, PREVIOUS_MAIN_PARAMS))
    ...
    void shouldReturnBookViewAndSetAttributes() throws Exception {
        ...
        BookPageParams bookPageParams = new BookPageParams(null, CURRENT_PAGE, TOTAL_PAGES);

        BookPageAttributes bookPageAttributes = new BookPageAttributes(bookList.get(0), bookList.get(0).getComments(), bookPageParams);

        Mockito.when(bookHandleService.getBookPageAttributes(BOOK_ID, NEXT_PAGE, PREVIOUS_BOOK_PARAMS)).thenReturn(bookPageAttributes);
    ...
    void shouldReturnCreateViewAndSetAttributes() throws Exception {
        ...
        Mockito.when(bookHandleService.getCreateBookPageAttributes()).thenReturn(attributes);
    ...
    void shouldInvokeCreateBookMethodAndRedirectToMainPage() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post("/book/create")
                ...
                .param("genreList", String.valueOf(genreIds.get(0)))
                .param("genreList", String.valueOf(genreIds.get(1)))
        ...
        Mockito.verify(bookHandleService, Mockito.times(1))
                .createBook(book.getTitle(), genreIds, book.getAuthor().getId(), book.getDescription());
    ...
    void shouldReturnUpdateViewAndSetAttributes() throws Exception {
        ...
        Mockito.when(bookHandleService.getUpdateBookAttributes(book.getId())).thenReturn(attributes);
    ...
    void shouldInvokeUpdateBookMethodAndRedirectToMainPage() throws Exception {
        ...
        Mockito.verify(bookHandleService, Mockito.times(1))
                .updateBook(book.getId(), book.getTitle(), genreIds, book.getAuthor().getId(), book.getDescription());
    ...
    void shouldInvokeDeleteMethodAndRedirectToMainPage() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get("/book/delete/" + BOOK_ID))
                .andExpect(MockMvcResultMatchers.redirectedUrl("/"));
