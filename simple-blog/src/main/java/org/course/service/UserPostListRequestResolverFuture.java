...
public class UserPostListRequestResolverFuture implements UserPostListRequestResolver {
    ...
    public PostByUserListResponse getUserPosts(String userId, RequestParams params) {
        Page<Post> postPage = postRepository.findByUserIdAndPublicationTimeGreaterThan(
                PageRequest.of(params.getPageNumber(), params.getPageSize()), userId,  LocalDateTime.now());
